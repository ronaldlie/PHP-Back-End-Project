...
<?php
    ...
    if(isset($_POST['Simpan'])) {
        ...
        mysqli_query($connection, "insert into kecamatan values ('$destinasikode', 
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Daftar Kecamatan Wisata</title>
...
<div class="col-sm-10">
  <input type="text" class="form-control" id="kodedestinasi" name="inputkode" placeholder="Kode kecamatan" maxlength="4">
</div>
</div>
...
<div class="col-sm-10">
  <input type="text" class="form-control" name="inputnama" id="namadestinasi" placeholder="Nama kecamatan">
</div>
</div>
...
<div class="col-sm-10">
  <input type="text" class="form-control" name="keterangan" id="ketkabu" placeholder="kelurahan">
</div>
</div>
