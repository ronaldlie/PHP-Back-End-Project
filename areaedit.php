...
<?php
    ...
    if(isset($_POST['ubah'])) {
        ...
        $areaketerangan = $_POST['keterangan'];
        ...
        areaketerangan = '$areaketerangan', provinsiID = '$idprovinsi'
    ...
    $editdestinasi = mysqli_query($connection, "SELECT * FROM area
    WHERE areaID = '$kodedestinasi'");
    $rowedit = mysqli_fetch_array($editdestinasi);

    $editkategori = mysqli_query($connection, "SELECT * 
    FROM area, provinsi
    WHERE areaID = '$kodedestinasi' and area.provinsiID = provinsi.provinsiID");
...
<div class="col-sm-10">
  <input type="text" class="form-control" name="inputkode" id="kodearea"value="<?php echo $rowedit["areaID"]?>">
</div>
</div>
...
<div class="col-sm-10">
  <input type="text" class="form-control" name="wilayaharea" id="wilayaharea" value="<?php echo $rowedit["areawilayah"]?>">
</div>
</div>
...
<div class="col-sm-10">
  <input type="text" class="form-control" name="keterangan" id="ketarea" value="<?php echo $rowedit["areaketerangan"]?>">
</div>
</div>

<div class="form-group row">
<label for="idprov" class="col-sm-2 col-form-label">Kategori Wisata</label>
<div class="col-sm-10">
<select class="form-control" id="idprov" name ="provid">
<option value="<?php echo $rowedit["provinsiID"]?>"><?php echo $rowedit2['provinsiID']?>
...
<!-- memulai dengan menampilkan data -->
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    ...
                    <h2>Hasil Entri data pada Tabel Area Wisata</h2>
                </div>
            </div> <!-- penutup jumbotron -->
        ...
        <!-- <form method="POST">
            ...
            <table class="table table-hover table-sucess">
