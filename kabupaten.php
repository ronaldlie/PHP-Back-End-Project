...
<?php
    ...
    if(isset($_POST['Simpan'])) {
        ...
        mysqli_query($connection, "insert into kabupaten values ('$destinasikode', 
                        '$destinasinama', '$ketkabupaten', '$kodekategori')");
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Daftar Kabupaten Wisata</title>
...
<div class="col-sm-10">
  <input type="text" class="form-control" id="kodedestinasi" name="inputkode" placeholder="Kode Kabupaten" maxlength="4">
</div>
</div>
...
<div class="col-sm-10">
  <input type="text" class="form-control" name="inputnama" id="namadestinasi" placeholder="Nama Kabupaten">
</div>
</div>

<div class="form-group row">
<label for="ketkabu" class="col-sm-2 col-form-label">Keterangan</label>
<div class="col-sm-10">
  <input type="text" class="form-control" name="keterangan" id="ketkabu" placeholder="Keterangan kabupaten">
</div>
</div>
