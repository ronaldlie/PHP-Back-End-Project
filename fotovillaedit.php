...
<?php
    ...
    if(isset($_POST['Ubah']))
    {
        ...
        if(Empty($nama))
        {
            mysqli_query($connection, "UPDATE villa SET villaname='$namafoto', villaketerangan='$kodedestinasi'
                WHERE villaID = '$kodefoto'");
            header("location:fotovilla.php");
        } 
        ...
        if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
        {
            ...
            mysqli_query($connection, "UPDATE villa SET villaname='$namafoto', villaketerangan='$kodedestinasi', villafoto='$nama'
                WHERE villaID = '$kodefoto'");
            header("location:fotovilla.php");
        }
    }
    ...
    $editfoto = mysqli_query($connection, "SELECT * FROM villa
       WHERE villaID = '$kodefoto'");
    ...
    <div class="col-sm-10">
        ...
        <form method="POST" enctype="multipart/form-data">
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="kodefoto" name="inputkode" value="<?php echo $rowedit["villaID"]?>" readonly>
                </div>            
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="namafoto" name="inputnama" value="<?php echo $rowedit["villaname"]?>">
                </div>            
            </div>

            <div class="form-group row">
                <label for="namadestinasi" class="col-sm-2 col-form-label">Keterangan Villa</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="namadestinasi" name="kodedestinasi" value="<?php echo $rowedit["villaketerangan"]?>">  
                </div>            
            </div>
            
            <div class="form-group row">
                <label for="filee" class="col-sm-2 col-form-label">Photo Villa</label>
                <div class="col-sm-10">
                    <input type="file" id="file" name="file">
                    <img src="images/<?php echo $rowedit['villafoto']?>" style="width: 200px; height: 100px;">
