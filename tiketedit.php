...
<?php
    ...
    if(isset($_POST['Edit'])) {
        ...
        mysqli_query($connection, "UPDATE tiket set tiketkelas = '$tiketkelas', 
        tiketwisata = '$tiketwisata' WHERE tiketID = '$tiketID'");
        
        header("location:tiket.php");
    }

    $tiketID = $_GET["ubah"];
    $editdestinasi = mysqli_query($connection, "SELECT * FROM tiket WHERE tiketID = '$tiketID'");
...
<div class="col-sm-10">
            ...
            <div class="jumbotron jumbotron-fluid">
                <div class="container">
                    <h1 class="display-4">Edit Tiket Wisata</h1> 
                </div>
...
<div class="col-sm-10">
  <input type="text" class="form-control" id="kodedestinasi" name="inputkode" value="<?php echo $rowedit["tiketID"]?>" readonly>
</div>
</div>
...
<div class="form-group row">
    ...
    <select name="inputnama" class="form-control" id="saran">
        <option value="<?php echo $rowedit['tiketkelas']?>"><?php echo $rowedit['tiketkelas']?></option>
  ...
  <div class="form-group row">
    <label for="alamat" class="col-sm-2 col-form-label">Jenis Wisata</label>
    <div class="col-sm-10">
    <select name="keterangan" class="form-control" id="alamat">
        <option value="<?php echo $rowedit['tiketwisata']?>"><?php echo $rowedit['tiketwisata']?></option>
