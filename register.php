...
<?php
    ...
    if(isset($_POST['Daftar'])) {
        ...
        mysqli_query($connection, "insert into admin values ('$adminID', 
...
<body class="bg-gradient" style="background-color: #38ada9;">
                            ...
                            <div class="col-lg-6">
                                        <div class="p-5">
                                            ...
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user" id="adminID" name="inputid"
                                                    placeholder="Admin ID" required>
                                            </div>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control form-control-user" id="name" name="inputnama"
                                                    placeholder="Nama">
                                            </div>
                                        </div>
                                        ...
                                        <input type="submit" name="Daftar" class="btn btn-primary btn-user btn-block" value="Register">
