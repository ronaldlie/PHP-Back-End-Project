...
<?php
    ...
    if(isset($_POST['Simpan'])) {
        ...
        mysqli_query($connection, "insert into area values ('$areakode', 
                        '$areanama', '$areawilayah', '$areaketerangan', '$idprovinsi')");
...
<div class="col-sm-10">
  <input type="text" class="form-control" name="inputkode" id="kodearea" placeholder="Kode Area">
</div>
</div>
...
<div class="col-sm-10">
  <input type="text" class="form-control" name="wilayaharea" id="wilayaharea" placeholder="Wilayah Area">
</div>
</div>
...
<div class="col-sm-10">
  <input type="text" class="form-control" name="keterangan" id="ketarea" placeholder="Keterangan Area">
</div>
</div>
